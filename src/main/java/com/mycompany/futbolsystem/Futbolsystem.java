...
public class Futbolsystem extends JFrame {
        ...
        menuList.addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting()) {
                ...
                if (selectedItem != null) {
                    ...
                    if (selectedItem.equals("Inicio")) {
                    ...
                    } else if (selectedItem.equals("Selecciones")) {
                        ...
                        ocultarSeleccionPrincipal();
                    } else if (selectedItem.equals("Resultados")) {
                    ...
                    } else if (selectedItem.equals("Auditoría")) {
                    ...
                    } else if (selectedItem.equals("Selección Principal")) {
                    ...
                    } else if (selectedItem.equals("Resultado General")) {
    ...
    private void mostrarPanelInicio() {
        if (inicioPanel == null) {
            ...
            File file = new File("src/resources/balon.png");
String folderPath = file.getAbsolutePath();
            System.out.println( folderPath);
            // Cargar y mostrar la imagen
            //ImageIcon imagenInicio = new ImageIcon(getClass().getResource("balon.png"));
            //ImageIcon imagenInicio = new ImageIcon("C:\\Users\\ICARIUS\\Pictures\\balon.png");
            ImageIcon imagenInicio = new ImageIcon(folderPath);
    ...
    private void generarResultadosPrincipales2() {
        ...
        for (int i = 0; i < tablaModelResultados.getRowCount(); i++) {
            ...
            golesPorPais.put(equipoLocal, golesPorPais.getOrDefault(equipoLocal, 0) + Integer.parseInt((String) golesEquipoLocal));
            golesPorPais.put(equipoVisitante, golesPorPais.getOrDefault(equipoVisitante, 0) + Integer.parseInt((String) golesEquipoVisitante));
        }
